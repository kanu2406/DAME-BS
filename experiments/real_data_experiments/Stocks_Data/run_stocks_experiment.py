...
def main():
    """
    This script runs a 500-trial comparison of Kent's mean estimator,Girgis mean estimator and DAME-BS
    ...
    for trial in range(num_exp):
        ...
        try:
            ...
            t1 = time.time()
            time_g = t1 - t0
            theta_hat_girgis_orig = 0.5 * (theta_hat_girgis_scaled + 1) * (max_val - min_val) + min_val
