...
def main():
    """
    Main experiment function for evaluating Kent's algorithm, Girgis' algorithm and DAME-BS 
    ...
    user_samples_scaled, vmin,vmax,true_mean,true_mean_scaled = scaling(pid_and_sleep_final)
    print("Scaling Done.")
    ...
    num_exp = 500
    base_seed = 42             
    out_trials_csv = "experiments/real_data_experiments/globem/results/sleep_trials.csv"
    out_summary_csv = "experiments/real_data_experiments/globem/results/sleep_summary.csv"
    ...
    for trial in range(num_exp):
        ...
        np.random.seed(seed)
        random.seed(seed)
        durations=user_samples_scaled.copy()
    ...
    # compute summary
    summary = {
        "dataset": "GLOBEM_sleep_duration_Data",
        "n": n,
        "m": m,
        "alpha": alpha,
        "trials": num_exp,
